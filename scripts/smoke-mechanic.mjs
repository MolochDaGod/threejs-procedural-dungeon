...
import { ANIM_URLS, CLASS_IDS, CLASS_WEAPON_SETS, COMBAT_DEPLOY, DRESSING, DUNGEON_KINDS, DUNGEON_SI, HERO_24, PIRATE_FACES, PLAY, PLAY_DEFAULTS, PROP_KITS, creatureOf, creaturesForBiome, loadoutFor, skillById } from '../src/ssot.js';
...
report.ruinPieces = ['modular', 'brick', 'halloween'].every((id) => PROP_KITS[id].pieces.some((p) => p.role === 'ruin'));
