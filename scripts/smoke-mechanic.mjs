...
import { ANIM_URLS, CLASS_IDS, CLASS_WEAPON_SETS, COMBAT_DEPLOY, CRAFT_SUITE, DRESSING, DUNGEON_KINDS, DUNGEON_SI, ESTES_CAST_DONOR, HERO_24, MAIN_PANEL, PIRATE_FACES, PLAY, PLAY_DEFAULTS, PROP_KITS, creatureOf, creaturesForBiome, loadoutFor, skillById } from '../src/ssot.js';
...
import { BIP001_PLAY, MIXAMO_PACKS } from '../src/play/clipLibrary.js';
...
report.mixamoCatalog = !!MIXAMO_PACKS.packs.traversal && !!MIXAMO_PACKS.packs.rifle && !!MIXAMO_PACKS.packs.action_adventure;
