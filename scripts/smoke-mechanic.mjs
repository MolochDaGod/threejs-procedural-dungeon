...
import { ANIM_URLS, CLASS_IDS, CLASS_WEAPON_SETS, COMBAT_DEPLOY, CRAFT_SUITE, DRESSING, DUNGEON_KINDS, DUNGEON_SI, HERO_24, MAIN_PANEL, PIRATE_FACES, PLAY, PLAY_DEFAULTS, PROP_KITS, creatureOf, creaturesForBiome, loadoutFor, skillById } from '../src/ssot.js';
...
import { CLIP_DONOR_NAMES, CLIP_SKIP, CLIP_FALLBACK, classifyClips, resolveClipName, animForSpell, hitWindowSec } from '../src/play/clipRoles.js';
...
report.noTorchPointLights = !/placeTorch[\s\S]*new THREE\.PointLight/.test(dressSrc);
