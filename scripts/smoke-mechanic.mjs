...
import { BIP001_PLAY, MIXAMO_PACKS, BIP001_DISK, CLIP_READERS, bip001ExtraForWeapon } from '../src/play/clipLibrary.js';
...
report.rifleExtra = bip001ExtraForWeapon('rifle').length >= 6 && bip001ExtraForWeapon('sword_shield').length === 0;
