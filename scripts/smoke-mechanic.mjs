...
report.meshoptKits = !readFileSync(new URL('../src/props/kitPlant.js', import.meta.url), 'utf8').includes('new GLTFLoader')
  && !readFileSync(new URL('../src/props/gates.js', import.meta.url), 'utf8').includes('new GLTFLoader');
report.locUuid = readFileSync(new URL('../src/physics/colliders.js', import.meta.url), 'utf8').includes('grudge.loc.');
report.skillUuid = readFileSync(new URL('../src/play/skillApi.js', import.meta.url), 'utf8').includes('grudge.skill.');
...
report.animWarcry = animForSpell(swordRoles, { kind: 'nova', anim: 'warcry' }) === 'warcry';
report.tauntWarcry = CLASS_SKILL_0.warrior.anim === 'warcry';
report.warcryJson = existsSync(new URL('../public/models/anims/bip001/sword/taunt_battlecry.json', import.meta.url));
