...
export const PROP_KITS = {
  dungeon: {
    ...
    biomes: ['ancient', 'grim'],
    pieces: [
      { id: 'pillar', mesh: 'Pillar_Bricks001_0', role: 'pillar', h: 3.2, block: true, hp: 88 },
      { id: 'wall', mesh: 'Full Wall_Bricks001_0', role: 'wall', h: 3.2, block: true, hp: 110 },
      { id: 'chest', mesh: 'Chest_Wood_0', role: 'prop', h: 0.9, block: false },
      { id: 'table', mesh: 'Table_Wood_0', role: 'debris', h: 0.9, block: true, hp: 28 },
      { id: 'pot', mesh: 'Pot_ceramic_0', role: 'debris', h: 0.45, block: false, hp: 12 },
  ...
  brick: {
    ...
    pieces: [
      { id: 'wall', mesh: 'Brick_Wall__0', role: 'wall', h: 2.55, block: true, hp: 110 },
      { id: 'mid', mesh: 'Brick_Mid_Wall__0', role: 'wall', h: 1.4, block: true, hp: 70 },
      { id: 'pillar1', mesh: 'Brick_Pillar_1__0', role: 'pillar', h: 2.55, block: true, hp: 88 },
      { id: 'pillar2', mesh: 'Brick_Pillar_2__0', role: 'pillar', h: 2.55, block: true, hp: 88 },
  ...
  halloween: {
    ...
    pieces: [
      ...
      { id: 'stone', mesh: 'Stone_06_Stone_06_0', role: 'debris', h: 1.3, block: true, hp: 40 },
      { id: 'coffin', mesh: 'Coffin_Coffin_0', role: 'debris', h: 0.7, block: true, hp: 55 },
      { id: 'wall', mesh: 'Wall_02_BrickSmallBrown_0', role: 'wall', h: 2.4, block: true, hp: 110 },
  ...
  modular: {
    ...
    biomes: ['ancient', 'grim'],
    pieces: [
      { id: 'wall', mesh: 'Wall_Piece_02 - Default_0', role: 'wall', h: 2.8, block: true, hp: 110 },
      { id: 'wallStone', mesh: 'Wall_Stones_A_03 - Default_0', role: 'wall', h: 2.4, block: true, hp: 96 },
      { id: 'pillar', mesh: 'Pillar_03 - Default_0', role: 'pillar', h: 3.2, block: true, hp: 88 },
      { id: 'brick', mesh: 'Brick_A_03 - Default_0', role: 'debris', h: 0.45, block: true, hp: 40 },
      { id: 'barrel', mesh: 'Barrel_09 - Default_0', role: 'debris', h: 0.9, block: true, hp: 36 },
      { id: 'table', mesh: 'Table_Small_08 - Default_0', role: 'debris', h: 0.85, block: true, hp: 28 },
